...
<body class="d-flex flex-column h-100">
				...
				<div class='card-footer'>
					...
					<c:if test="${show_annuncio_attr.aperto}">
						<sec:authorize access="isAuthenticated()">
							<a id="acquistoLink_${show_annuncio_attr.id}" class="btn btn-success link-for-modal" data-bs-toggle="modal" data-bs-target="#confirmOperationModal">
								Acquista
							</a>
						</sec:authorize>

						<sec:authorize access="!isAuthenticated()">
							<a class="btn btn-success" href="${pageContext.request.contextPath}/annuncio/acquistaWithoutAuth?idAnnuncioWithNoAuth=${show_annuncio_attr.id}">
								Acquista
							</a>
						</sec:authorize>
					</c:if>
	...
	<!-- Modal -->
	<div class="modal fade" id="confirmOperationModal" tabindex="-1" aria-labelledby="confirmOperationModalLabel" aria-hidden="true">
	...
	<script type="text/javascript">
		...
		$(".link-for-modal").click(function(){
			<!-- mi prendo il numero che poi sarà l'id. Il 18 è perché 'acquistoLink_' è appunto lungo 13  -->
			var callerId = $(this).attr('id').substring(13);
